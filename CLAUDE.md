...
- **SITE 2 NO AR (em construção local): `cutfill-calc`** — 9 calculadoras de terraplanagem (EUA, inglês), repo separado em `C:\claude sites\cutfill-calc`. Âncora: cut & fill pelo método de grade, a única SERP em 22 buscas sem nenhuma ferramenta concorrente. Falta Arthur comprar o domínio e conectar Cloudflare Pages.
